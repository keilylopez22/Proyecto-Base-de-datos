...
VALUES
-- Registro 1: Visita completada. Entra por Garita 1, autorizado por Empleado 1.
('2025-10-06 07:45:00', '2025-10-06 08:30:00', 'DPI',     'DPI-11112222333', 1, 1, 11, 1, 1),  

-- Registro 2: Visita completada. Entra por Garita 2, autorizado por Empleado 2.
('2025-10-06 11:00:00', '2025-10-06 12:00:00', 'Licencia','LIC-L12345678',   2, 1, 13, 2, 2), 

-- Registro 3: Visita completada. Entra por Garita 3, autorizado por Empleado 3.
('2025-10-06 14:00:00', '2025-10-06 15:30:00', 'DPI',     'DPI-22223333444', 3, 2, 26, 3, 3), 

-- Registro 4: Visita en curso (FechaSalida = NULL). Entra por Garita 4, autorizado por Empleado 4.
('2025-10-06 17:00:00', NULL, 'Licencia','LIC-L98765432',   4, 2, 27, 4, 4), 

-- Registro 5: Visita de servicio completada. Entra por Garita 5, autorizado por Empleado 5.
('2025-10-07 09:15:00', '2025-10-07 10:40:00', 'DPI',     'DPI-33334444555', 5, 3, 312, 5, 5),

-- Registro 6: Visita en curso (FechaSalida = NULL). Entra por Garita 6, autorizado por Empleado 6.
('2025-10-07 15:30:00', NULL, 'Licencia','LIC-L11223344',   6, 3, 313, 6, 6),

-- Registro 7: Visita completada. Entra por Garita 7, autorizado por Empleado 7.
('2025-10-08 08:00:00', '2025-10-08 09:30:00', 'DPI',     'DPI-44445555666', 7, 4, 416, 7, 7),

-- Registro 8: Visita completada. Entra por Garita 8, autorizado por Empleado 8.
('2025-10-08 14:30:00', '2025-10-08 16:00:00', 'Licencia','LIC-L55667788',   8, 4, 417, 8, 8),

-- Registro 9: Visita completada. Entra por Garita 9, autorizado por Empleado 9.
('2025-10-09 18:30:00', '2025-10-09 20:00:00', 'DPI',     'DPI-55556666777', 9, 5, 521, 9, 9),

-- Registro 10: Visita completada. Entra por Garita 10, autorizado por Empleado 10.
